...
import type { ExternalBlob as _ExternalBlob, Photo as _Photo, PhotoType as _PhotoType, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async cardOpened(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.cardOpened();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOpenedCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getOpenedCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPhoto(arg0: PhotoType): Promise<Photo | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getPhoto(to_candid_PhotoType_n8(this._uploadFile, this._downloadFile, arg0));
    ...
    async uploadPhoto(arg0: PhotoType, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadPhoto(to_candid_PhotoType_n8(this._uploadFile, this._downloadFile, arg0), await to_candid_ExternalBlob_n16(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_PhotoType_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PhotoType): PhotoType {
...
async function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Photo]): Promise<Photo | null> {
    return value.length === 0 ? null : await from_candid_Photo_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        photoType: from_candid_PhotoType_n13(_uploadFile, _downloadFile, value.photoType),
...
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "portrait" in value ? PhotoType.portrait : "couple" in value ? PhotoType.couple : value;
}
...
function to_candid_PhotoType_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PhotoType): _PhotoType {
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PhotoType): {
    portrait: null;
} | {
    couple: null;
} {
    return value == PhotoType.portrait ? {
        portrait: null
    } : value == PhotoType.couple ? {
        couple: null
    } : value;
}
